...
MODEL_PATH = 'best_transformer_driver_model7.pth' # 指定訓練好的模型檔案

# 【更新】與 transformer_model_beta3.py 同步
SEQUENCE_LENGTH = 20
IMG_HEIGHT = 224
IMG_WIDTH = 224
D_MODEL = 768
...
# 【更新】從 transformer_model_beta3.py 複製過來的 ComplexVisionTransformerDriver
...
p.setAdditionalSearchPath("3Dmodel")
