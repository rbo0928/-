...
p.loadURDF(r"C:\Users\ChingFa Wu\Desktop\--1\3Dmodel\test.urdf", basePosition=[0,0,-0.07])
...
humanoid = p.loadURDF(r'C:\Users\ChingFa Wu\Desktop\--1\3Dmodel\man.urdf', humanoidStartPos, humanoidStartOrientation)
...
r2d2 = p.loadURDF(r'C:\Users\ChingFa Wu\Desktop\--1\3Dmodel\front_car.urdf', r2d2StartPos, r2d2StartOrientation)
...
try:
    while True:
        ...
        if ord('8') in keys and keys[ord('8')] & p.KEY_WAS_TRIGGERED:
            p.resetBasePositionAndOrientation(r2d2, [2.3, 14.4, 0.5], [0, 0, 0, 1])
        if ord('9') in keys and keys[ord('9')] & p.KEY_WAS_TRIGGERED:
            p.resetBasePositionAndOrientation(r2d2, [0, 1.25, 2], [0, 0, 0, 1])            
        if ord('0') in keys and keys[ord('0')] & p.KEY_WAS_TRIGGERED:
            p.resetBasePositionAndOrientation(r2d2, [-5, -15.5, 0.5], [0, 0, 0, 1])  
