...
BEST_MODEL_SAVE_PATH = 'best_transformer_driver_model3ㄋ.pth'
...
if __name__ == '__main__':
    if not all([os.path.exists(p) for p in [TRAIN_CSV_PATH, VAL_CSV_PATH, TEST_CSV_PATH]]):
        ...
        train_dataset = DrivingDataset(TRAIN_CSV_PATH, os.path.join(TRAIN_DIR, 'recorded_images'), SEQUENCE_LENGTH, transform=train_transform, is_training=True)
